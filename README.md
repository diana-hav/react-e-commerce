...
1. Update `package.json` "homepage" with your GitHub username and repo name.
2. Update `vite.config.js` base with your repo name.
3. Run `npm run build`
4. Push the `dist/` folder to the `gh-pages` branch or use GitHub Actions for automatic deployment.
